...
<form role="search" method="get" class="form dark form-search" action="<?php echo esc_url(home_url('/')); ?>">
    <label class="form-field">
        <input type="text" value="<?php echo $search_result; ?>" name="s" placeholder="Search">
    </label>
