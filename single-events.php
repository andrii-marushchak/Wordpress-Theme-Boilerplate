...
<main class="single-events-template">
    <div class="container">
        ...
        <div class="page-row">
            ...
            <div class="col-right">
                <div class="event-info">
                    ...
                    <!-- Photo -->
                    <picture class="event-photo-wrap">
						<?php echo wp_get_attachment_image(get_field('event_photo'), 'full'); ?>
                    ...
                    <div class="event-info__inner">
						<?php if (get_field('event_title')): ?>
                            <!-- Title -->
                            <h4 class="event-title"><?php the_field('event_title'); ?></h4>
						<?php endif; ?>

						<?php if (get_field('featuring')): ?>
                            <!-- Featuring -->
                            <div class="event-featuring"><?php the_field('featuring'); ?></div>
						<?php endif; ?>

						<?php $date = get_field('date') ?>
						<?php if ($date): ?>
                            <date class="event-date">
                                <span class="event-date__start"><?php echo $date['start_date'] ?></span>
                                <span class="divider">-</span>
                                <span class="event-date__end"><?php echo $date['end_date'] ?></span>
                            </date>
						<?php endif; ?>
                        ...
                        <time class="event-time">
                            <span class="event-time__start"><?php echo $time['start_time'] ?></span>
                            <span class="divider">-</span>
                            <span class="event-time__end">
						...
						<?php if (get_field('price_label')): ?>
                            <div class="event-price">
								<?php the_field('price_label'); ?>
                            </div>
						<?php endif; ?>

						<?php $btn = get_field('register_link') ?>
						<?php if ($btn): ?>
                            <a href="<?php echo $btn['url'] ?>" target="<?php echo $btn['target'] ?>" class="btn-cta btn btn-orange">
...
<path d="M6.37764 1.06558L7.12086 0.256833C7.43555 -0.0856111 7.94443 -0.0856111 8.25578 0.256833L14.764 7.33523C15.0787 7.67768 15.0787 8.23142 14.764 8.57022L8.25578 15.6523C7.94108 15.9947 7.43221 15.9947 7.12086 15.6523L6.37764 14.8435C6.05959 14.4974 6.06629 13.9328 6.39103 13.5939L10.4252 9.41176H0.803482C0.358219 9.41176 0 9.02195 0 8.53743V7.37166C0 6.88714 0.358219 6.49734 0.803482 6.49734H10.4252L6.39103 2.31514C6.06294 1.97634 6.05624 1.41167 6.37764 1.06558Z"
      fill="white"></path>
                ...
                <div class="discount">
                    <div class="discount__caption">Discount code:</div>
                    <div class="discount-row">
                        <div class="discount__code"><?php the_field('discount_code'); ?></div>
                        <button class="btn-copy-discount">
                            <svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.14286 10.5V11.4375C7.14286 11.7482 6.90301 12 6.60714 12H0.535714C0.239844 12 0 11.7482 0 11.4375V2.8125C0 2.50184 0.239844 2.25 0.535714 2.25H2.14286V9.1875C2.14286 9.91123 2.70359 10.5 3.39286 10.5H7.14286ZM7.14286 2.4375V0H3.39286C3.09699 0 2.85714 0.251836 2.85714 0.5625V9.1875C2.85714 9.49816 3.09699 9.75 3.39286 9.75H9.46429C9.76016 9.75 10 9.49816 10 9.1875V3H7.67857C7.38393 3 7.14286 2.74687 7.14286 2.4375ZM9.8431 1.71026L8.37118 0.164742C8.27072 0.05926 8.13446 7.79991e-07 7.99239 0L7.85714 0V2.25H10V2.10799C10 1.95881 9.94356 1.81575 9.8431 1.71026V1.71026Z"
                                      fill="white"/>
                            </svg>
                        </button>
                    </div>
